 ...
 *     - 2014-02-03 : taken into account NurseryRegistrationIsLate field
 *
 * @since 2012-02-14
 *
 * @param $DbConnection                      DB object    Object of the opened database connection
             ...
             if ($DbResult->numRows() == 0)
             {
                 ...
                 if ($id != 0)
                 {
                     $DbResult = $DbConnection->query("INSERT INTO NurseryRegistrations SET NurseryRegistrationID = $id, ChildID = $ChildID,
                                                      ...
                                                      $NurseryRegistrationForDate $NurseryRegistrationAdminDate");
                     if (!DB::isError($DbResult))
                     {
                         return $id;
                     }
 ...
 *     - 2014-02-06 : patch pb about search modes on "NurseryRegistrationForDate" field
 *
 *
 * @since 2012-02-14
 *
 ...
 *     - 2014-02-03 : taken into account NurseryRegistrationIsLate field and ForAM and ForPM criterion and patch pb
 ...
 */
 function getNurseryRegistrations($DbConnection, $StartDate, $EndDate = NULL, $OrderBy = 'NurseryRegistrationForDate', $ChildID = NULL, $Mode = PLANNING_BETWEEN_DATES, $ArrayParams = array())
 {
     ...
     $Select = "SELECT nr.NurseryRegistrationID, nr.NurseryRegistrationDate, nr.NurseryRegistrationForDate, nr.NurseryRegistrationAdminDate,
               nr.NurseryRegistrationForAM, nr.NurseryRegistrationForPM, nr.NurseryRegistrationChildGrade,
