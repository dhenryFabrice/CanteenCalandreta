...
/*
DHTML Librairie IE4.x/5.x (Version 2.3 - 03/12/2000)
Copyright E.D Prod.
...
function CreerZone(nom,x1,y1,x2,y2){document.all[nom].style.clip = "rect("+y1+","+x2+","+y2+","+x1+")";}
function ChangeIndex(nom,valeur) {document.all.item(nom).style.zIndex=valeur;}
function CacherObj(nom){document.all.item(nom).style.visibility = "hidden";}
function VoirObj(nom){document.all.item(nom).style.visibility = "visible";}
function ModifierObj(nom,contenu){document.all.item(nom).innerHTML=contenu;}
function PlacerObj(nom,px,py) {if (px!=-10000) {document.all.item(nom).style.left = px;}if (py!=-10000) {document.all.item(nom).style.top = py;}}
function ObjX(nom){var chaine=document.all.item(nom).style.left;var value=parseInt(chaine.substring(0,chaine.length-2));return value;}
function ObjY(nom){var chaine=document.all.item(nom).style.top;var value=parseInt(chaine.substring(0,chaine.length-2));return value;}
function Mouvement() {MXP = event.clientX+document.body.scrollLeft;MYP = event.clientY+document.body.scrollTop;for ( j = 0 ; j < PtObj ; j++ ) {if ((Dobj[j]==1)){PlacerObj(Nobj[j],MXP-decaX,MYP-decaY);return false;}}}
function Clique() {MXP = event.clientX+document.body.scrollLeft;MYP = event.clientY+document.body.scrollTop;for ( j = 0 ; j < PtObj ; j++ ) {if (DDobj[j]){if ((MXP>=ObjX(Nobj[j])) && (MXP<=ObjX(Nobj[j])+SobjX[j]) && (MYP>=ObjY(Nobj[j])) && (MYP<=ObjY(Nobj[j])+SobjY[j])){Dobj[j]=1;decaX=MXP-ObjX(Nobj[j]);decaY=MYP-ObjY(Nobj[j]);}else {Dobj[j]=0;}}}}
...
function MoveObj(nom,x1,y1,x2,y2,vit){BUF[pt2]=1;pt2+=1;BUF[pt2]=nom;pt2+=1;BUF[pt2]=x1;pt2+=1;BUF[pt2]=y1;pt2+=1;BUF[pt2]=x2;pt2+=1;BUF[pt2]=y2;pt2+=1;BUF[pt2]=vit;pt2+=1;BUF[pt2]=x1;pt2+=1;BUF[pt2]=y1;pt2+=1;BUF[pt2]=vit;pt2+=1;pt+=1;}
function BounceObj(nom,x1,y1,y2,vit){BUF[pt2]=2;pt2+=1;BUF[pt2]=nom;pt2+=1;BUF[pt2]=x1;pt2+=1;BUF[pt2]=y1;pt2+=1;BUF[pt2]=y2;pt2+=1;BUF[pt2]=vit;pt2+=1;BUF[pt2]=y1;pt2+=1;BUF[pt2]=0;pt2+=1;BUF[pt2]=1;pt2+=1;pt+=1;}
...
function RotateObj(nom,px,py,rx,ry,debut,fin,vit){BUF[pt2]=3;pt2+=1;BUF[pt2]=nom;pt2+=1;BUF[pt2]=px;pt2+=1;BUF[pt2]=py;pt2+=1;BUF[pt2]=rx;pt2+=1;BUF[pt2]=ry;pt2+=1;BUF[pt2]=debut;pt2+=1;BUF[pt2]=fin;pt2+=1;BUF[pt2]=vit;pt2+=1;BUF[pt2]=debut;pt2+=1;BUF[pt2]=1;pt2+=1;pt+=1;}
...
function PassObj(nom,x1,y1,x2,y2,vit){BUF[pt2]=6;pt2+=1;BUF[pt2]=nom;pt2+=1;BUF[pt2]=x1;pt2+=1;BUF[pt2]=y1;pt2+=1;BUF[pt2]=x2;pt2+=1;BUF[pt2]=y2;pt2+=1;BUF[pt2]=vit;pt2+=1;BUF[pt2]=x1;pt2+=1;BUF[pt2]=y1;pt2+=1;BUF[pt2]=vit;pt2+=1;pt+=1;}
...
function CacherStaticObj(nom){document.all.item(nom).style.display = "none";}
function VoirStaticObj(nom){document.all.item(nom).style.display = "block";}
function VisibiliteObj(nom){if (document.all.item(nom).style.display == "none") {return false} else {return true};}
    ...
    if (BUF[pt3+7]) {
     ...
     if (ry>cy2) {
      ry=cy2;dy=-(dy/1.75);if ((dy>=-2) && (dy<=2)) {BUF[pt3+7]=0;nbi=0;}
         ...
         dy+=nbi;PlacerObj(nom,Math.round(cx1),Math.round(ry));
