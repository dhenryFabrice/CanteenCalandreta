 ...
 * @author Christophe Javouhey
 * @version 1.3
 *     - 2013-12-16 : taken into account the BillPaidAmount field
 *     - 2014-02-03 : taken into account the BillNurseryNbDelays field
 *     - 2015-06-03 : BillDate field is now a datetime
 *
 * @since 2012-02-23
 *
 * @param $DbConnection                      DB object    Object of the opened database connection
 ...
 */
 function dbAddBill($DbConnection, $BillDate, $BillForDate, $FamilyID, $BillPreviousBalance = 0, $BillDeposit = 0, $BillMonthlyContribution = 0, $BillCanteenAmount = 0, $BillWithoutMealAmount = 0, $BillNurseryAmount = 0, $BillPaidAmount = 0.00, $BillNurseryNbDelays = 0)
 {
 ...
 */
 function dbUpdateBill($DbConnection, $BillID, $BillDate, $BillForDate, $FamilyID, $BillPreviousBalance = NULL, $BillDeposit = NULL, $BillMonthlyContribution = NULL, $BillCanteenAmount = NULL, $BillWithoutMealAmount = NULL, $BillNurseryAmount = NULL, $BillPaidAmount = NULL, $BillNurseryNbDelays = NULL)
 {
 ...
 * @author Christophe Javouhey
 * @version 1.4
 *     - 2013-01-20 : taken into account the "IncludeBillID" parameter (allow to get some given Bill ID
 *                    without taken into account other parameters)
 *     - 2013-12-16 : taken into account the BillPaidAmount field
 *     - 2014-02-03 : taken into account the BillNurseryNbDelays field
 *     - 2014-03-12 : add the $LimitRecords parameter
 *     - 2015-06-04 : allow to filter bills on the BillDate field
 *
 * @since 2012-02-23
 *
 * @param $DbConnection         DB object            Object of the opened database connection
 ...
 */
 function getBills($DbConnection, $StartDate, $EndDate = NULL, $OrderBy = 'BillForDate', $Mode = PLANNING_BETWEEN_DATES, $ArrayParams = array(), $LimitRecords = 0)
 {
     ...
     $Select = "SELECT b.BillID, b.BillDate, b.BillForDate, b.BillPreviousBalance, b.BillDeposit, b.BillMonthlyContribution,
               b.BillCanteenAmount, b.BillWithoutMealAmount, b.BillNurseryAmount, b.BillNurseryNbDelays, b.BillPaidAmount, b.BillPaid,
