 ...
 */
 ...
 define('Coop_ClosedEventsList', 4);
 define('Coop_FamiliesList', 5);
 define('Coop_CreateWorkGroup', 6);
 define('Coop_WorkGroupsList', 7);
 define('Coop_CreateDonation', 8);
 define('Coop_DonationsList', 9);
 define('Coop_GenerateTaxReceipt', 10);
