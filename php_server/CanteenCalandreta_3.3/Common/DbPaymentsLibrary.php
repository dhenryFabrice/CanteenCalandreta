 ...
 * @param $BillPartAmount                Float        Part amount of the payment alloacted to the bill, NULL otherwise
 *                                                    Can be an array if payment linked to several bills
 *
             ...
             if ($DbResult->numRows() == 0)
             {
                 ...
                 if ($id != 0)
                 {
                     $DbResult = $DbConnection->query("INSERT INTO Payments SET PaymentID = $id, FamilyID = $FamilyID,
                                                      ...
                                                      PaymentAmount = $PaymentAmount $PaymentDate $PaymentReceiptDate $PaymentCheckNb
                                                      $BankID");
