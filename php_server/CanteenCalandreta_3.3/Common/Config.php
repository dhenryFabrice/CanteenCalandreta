...
/**
 * Common module : configuration file of CanteenCalandreta v3.3
 *
 ...
 *     - 2016-09-09 : taken into account $CONF_PAYMENTS_MANUAL_BILL_PART_AMOUNT, $CONF_ACTIVATION_ICON, $CONF_JOBS_EXECUTION_DELAY
 *                    and allow to load some variables of configuration from database.
 *     - 2017-09-06 : allow partial read only on FCT_NURSERY_PLANNING and taken into account $CONF_NURSERY_REGISTER_DELAY_PLANNING_REGISTRATION,
 ...
 *     - 2018-05-16 : taken into account $CONF_DEFAULT_VALUES_SET
 *     - 2019-05-07 : taken into account documents approvals, $CONF_UPLOAD_DOCUMENTS_FILES_MAXSIZE, $CONF_UPLOAD_DOCUMENTS_FILES_DIRECTORY,
 ...
 */
 ...
 //########################### Mode parameters  ############################
 $CONF_MODE_DEBUG = TRUE;     // Active some functions used in the debug mode
 ...
 $CONF_DB_DATABASE               = 'CantineProd';      // Name of the database used by the application
 $CONF_DB_PORT                   = '';
 $CONF_DB_SGBD_TYPE              = 'mysqli';                // Type of SGBD : mysql, pgsql, oci8, MSAccess, IBMDB2,...
 ...
 $CONF_PAYMENTS_MODES_BANK_REQUIRED = array(1, 2);  // Indexes of payment modes for which the bank and check number are required
 ...
 $CONF_NURSERY_REGISTER_DELAY_PLANNING_REGISTRATION = 14;      // Nb of days for which the registration in the nurseray planning is allowed for users with FCT_ACT_PARTIAL_READ_ONLY access (ex : families)
 ...
 $CONF_DOCUMENTS_APPROVALS_TYPES         = array("Autorisation droit à l'image", "Autorisation de sortie", "Règlement intégrieur");  // Types of documents to approve
 ...
 $CONF_COOP_EVENT_TYPE_CATEGORIES                   = array("Festif", "Aide/Travaux");  // Categories to group event types
 ...
 $CONF_COOP_WORKGROUP_ALLOW_REGISTRATIONS_FOR_REFERENTS = TRUE;  // True to allow referents to registers families on a workgroup
 ...
 $CONF_DAYS_OF_WEEK                  = array("Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi");  // 5 days of the week to display in the planning of the asks of work
