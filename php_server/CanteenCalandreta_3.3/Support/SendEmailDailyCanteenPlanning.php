 ...
 *     - 2013-05-02 : use the function_exists() function to decalre getIntranetRootDirectoryHDD()
 *     - 2013-11-12 : taken into account opened special days to send a notification for these dates
