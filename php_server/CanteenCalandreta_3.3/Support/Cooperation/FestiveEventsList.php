...
/**
 * Support module : list some events of the "festive" event category
 *
 ...
 */
 ...
 if ((!empty($_POST["bSubmit"])) || (array_key_exists("hidOrderByField", $_POST)) || ($LaunchSearch))
 {
     ...
     $TabParams["EventTypeCategory"] = array(0);
 ...
 if ($HidOnPrint == 0)
 {
     ...
     if (isSet($_SESSION["SupportMemberID"]))
     {
         ...
         displaySupportMemberContextualMenu("cooperation", 1, Coop_FestiveEventsList);
     ...
     displayTitlePage($LANG_SUPPORT_FESTIVE_EVENTS_LIST_PAGE_TITLE, 2);

     openParagraph();
     echo $LANG_SUPPORT_FESTIVE_EVENTS_LIST_PAGE_INTRODUCTION;
     closeParagraph();
     ...
     displaySearchEventForm($DbCon, $TabParams, "FestiveEventsList.php", $Page, "SortFct", $OrderBy, "UpdateEvent.php",
