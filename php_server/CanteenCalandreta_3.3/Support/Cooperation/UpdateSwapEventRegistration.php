...
/**
 * Support module : allow a supporter to update an event swapped registration. The supporter must be logged to update
 * the event swapped registration.
 *
 ...
 */
 ...
 if (md5($Id) == $CryptedID)
 {
      displayDetailsSwapEventRegistrationForm($DbCon, $Id, 0, 0, "ProcessUpdateSwapEventRegistration.php",
