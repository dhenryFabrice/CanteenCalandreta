...
/**
 * Support module : allow a supporter to create a new opened special day.
 * The supporter must be logged to create the opened special day.
 *
 ...
 */
 ...
 if (md5($Id) == $CryptedID)
 {
     displayDetailsOpenedSpecialDayForm($DbCon, 0, "ProcessNewOpenedSpecialDay.php", $CONF_ACCESS_APPL_PAGES[FCT_ADMIN]);
 }
 else
 {
