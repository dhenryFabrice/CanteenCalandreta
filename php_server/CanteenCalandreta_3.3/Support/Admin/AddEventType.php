...
/**
 * Support module : allow a supporter to create a new event type.
 * The supporter must be logged to create the event type.
 *
 ...
 */
 ...
 if (md5($Id) == $CryptedID)
 {
     displayDetailsEventTypeForm($DbCon, 0, "ProcessNewEventType.php", $CONF_ACCESS_APPL_PAGES[FCT_ADMIN]);
 }
 else
 {
