...
/**
 * Support module : allow a supporter to create a new holiday.
 * The supporter must be logged to create the holiday.
 *
 ...
 */
 ...
 if (md5($Id) == $CryptedID)
 {
     displayDetailsHolidayForm($DbCon, 0, "ProcessNewHoliday.php", $CONF_ACCESS_APPL_PAGES[FCT_ADMIN]);
 }
 else
 {
