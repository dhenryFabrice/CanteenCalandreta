...
/**
 * Support module : allow a supporter to update a child. The supporter must be logged
 * to update the child.
 *
 ...
 */
 ...
 if (md5($Id) == $CryptedID)
 {
      displayDetailsChildForm($DbCon, $Id, NULL, "ProcessUpdateChild.php", $CONF_ACCESS_APPL_PAGES[FCT_FAMILY]);
 }
 else
 {
