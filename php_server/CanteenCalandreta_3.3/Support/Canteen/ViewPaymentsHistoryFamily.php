...
/**
 * Support module : allow a supporter to view the payments (of bills) history of a given family.
 *
 ...
 */
 ...
 if (md5($Id) == $CryptedID)
 {
     displayDetailsBillsPaymentsHistoryFamilyForm($DbCon, $Id, $CONF_ACCESS_APPL_PAGES[FCT_FAMILY]);
 }
 else
 {
