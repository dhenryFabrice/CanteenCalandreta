         ...
         if (in_array($cUserAccess, array(FCT_ACT_CREATE, FCT_ACT_UPDATE, FCT_ACT_READ_ONLY, FCT_ACT_PARTIAL_READ_ONLY)))
         {
             ...
             if ($DocumentApprovalID == 0)
             {
                 ...
                 $DocumentRecord = array(
                                         ...
                                         "DocumentApprovalDate" => date($GLOBALS['CONF_DATE_DISPLAY_FORMAT'].' '.$GLOBALS['CONF_TIME_DISPLAY_FORMAT']),
             ...
             // Display the form
             echo "<table id=\"DocumentDetails\" cellspacing=\"0\" cellpadding=\"0\">\n<tr>\n\t<td class=\"Label\">".$GLOBALS["LANG_REFERENCE"]."</td><td class=\"Value\">$Reference</td><td class=\"Label\">".$GLOBALS["LANG_DOCUMENT_APPROVAL_TYPE"]."</td><td class=\"Value\">$Type</td><td class=\"Label\">".ucfirst($GLOBALS["LANG_DATE"])."</td><td class=\"Value\">".$DocumentRecord["DocumentApprovalDate"]."</td>\n</tr>\n";
