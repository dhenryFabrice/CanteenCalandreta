                 ...
                 else
                 {
                     switch($cUserAccess)
                     {
                         ...
                         case FCT_ACT_UPDATE:
                             ...
                             $ClosingDate .= "<script language=\"JavaScript\" type=\"text/javascript\">\n<!--\n\t ClosingDateCalendar = new dynCalendar('ClosingDateCalendar', 'calendarCallbackClosingDate', '".$GLOBALS['CONF_ROOT_DIRECTORY']."Common/JSCalendar/images/'); \n\t//-->\n</script>\n";
                             break;
                     }
                 }
                 ...
                 switch($cUserAccess)
                 {
                     ...
                     case FCT_ACT_UPDATE:
                         ...
                         if ($GLOBALS['CONF_COOP_EVENT_USE_REGISTRATION_CLOSING_DATE'])
                         {
                             ...
                             // Insert the javascript to use the calendar component
                             $RegistrationDelay .= "<script language=\"JavaScript\" type=\"text/javascript\">\n<!--\n\t RegistrationClosingDateCalendar = new dynCalendar('RegistrationClosingDateCalendar', 'calendarCallbackRegistrationClosingDate', '".$GLOBALS['CONF_ROOT_DIRECTORY']."Common/JSCalendar/images/'); \n\t//-->\n</script>\n";
                         }
