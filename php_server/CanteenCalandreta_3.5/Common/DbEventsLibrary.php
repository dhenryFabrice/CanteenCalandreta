 ...
 *
 * @param $DbConnection                  DB object    Object of the opened database connection
 * @param $EventTypeName                 String       Name of the event type
...
/**
 * Update an existing event type in the EventTypes table
 *
 * @author Christophe Javouhey
 * @version 1.2
 ...
 *
 * @param $DbConnection                  DB object    Object of the opened database connection
 * @param $EventTypeID                   Integer      ID of the event type to update [1..n]
 * @param $EventTypeName                 String       Name of the event type
 ...
 function dbUpdateEventType($DbConnection, $EventTypeID, $EventTypeName = NULL, $EventTypeCategory = NULL)
 {
     ...
     if (isExistingEventType($DbConnection, $EventTypeID))
     {
         ...
         if (!DB::isError($DbResult))
         {
             if ($DbResult->numRows() == 0)
             {
                 // The event type exists and is unique : we can update if there is at least 1 parameter
 ...
 * @param $RecordsPerPage           Integer                Number of event types per page to return [1..n]
 *
 ...
 * @param $ArrayParams          Mixed array            Contains the criterion used to filter the event types
 *
 * @return Integer              Number of the event types found, 0 otherwise
 */
 ...
 *
 * @param $DbConnection                  DB object    Object of the opened database connection
 * @param $EventDate                     DateTime     Creation date of the event (yyyy-mm-dd hh:mm:ss)
