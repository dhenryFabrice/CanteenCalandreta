...
/*
DHTML Librairie NS6.x (Version 2.3 - 03/12/2000)
Copyright E.D Prod.
...
function CacherObj(nom){document.getElementById(nom).style.display = "none";}
function VoirObj(nom){document.getElementById(nom).style.display = "block";}
