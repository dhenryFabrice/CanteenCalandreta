 ...
 * @since 2015-10-21
 */
 function initAutoCompletionWorkGroupRegistrationLastnamePlugin(FormFieldName)
 {
     var AutoCompletionWorkGroupRegistrationLastnamePluginPath= '';

     $A(document.getElementsByTagName("script")).findAll( function(s) {
         return (s.src && s.src.match(/JSAutoCompletionWorkGroupRegistrationLastnamePlugin\.js(\?.*)?$/))
     }).each( function(s) {
         AutoCompletionWorkGroupRegistrationLastnamePluginPath = s.src.replace(/JSAutoCompletionWorkGroupRegistrationLastnamePlugin\.js(\?.*)?$/,'');
     });
     ...
     if (objFormField)
     {
         ...
         new Ajax.Autocompleter(
                                ...
                                AutoCompletionWorkGroupRegistrationLastnamePluginPath + 'PHPAutoCompletionWorkGroupRegistrationLastnamePlugin.php',
                                {
                                    method: 'post',
                                    paramName: 'debut',
                                    minChars: 3,
