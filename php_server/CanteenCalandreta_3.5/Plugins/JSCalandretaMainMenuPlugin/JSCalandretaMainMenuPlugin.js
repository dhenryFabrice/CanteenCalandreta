...
/**
 * JS plugin main menu module : replace main menu items by icons with colors onf tha Mureth Calandreta
 *
 ...
 * @since 2013-12-31
 */
 function initCalandretaMainMenuPlugin(Path)
 {
        // We don't activate this plugin for IE
        /*if (window.attachEvent) {
            for(var i = 0; i < document.styleSheets.length; i++) {
                if (document.styleSheets[i].href.indexOf('JSCalandretaMainMenuPluginStyles.css') != -1) {
