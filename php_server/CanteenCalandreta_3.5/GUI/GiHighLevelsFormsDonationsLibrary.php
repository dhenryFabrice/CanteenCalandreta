     ...
     if (isSet($_SESSION["SupportMemberID"]))
     {
         ...
         if (in_array($cUserAccess, array(FCT_ACT_CREATE, FCT_ACT_UPDATE, FCT_ACT_READ_ONLY, FCT_ACT_PARTIAL_READ_ONLY)))
         {
             ...
             switch($cUserAccess)
             {
                 case FCT_ACT_READ_ONLY:
                 case FCT_ACT_PARTIAL_READ_ONLY:
                     // We get infos about the selected family
             ...
             switch($cUserAccess)
             {
                 ...
                 case FCT_ACT_UPDATE:
                     ...
                     else
                     {
                         ...
                         $DonationReceptionDate .= "<script language=\"JavaScript\" type=\"text/javascript\">\n<!--\n\t DonationDateCalendar = new dynCalendar('DonationDateCalendar', 'calendarCallback', '".$GLOBALS['CONF_ROOT_DIRECTORY']."Common/JSCalendar/images/', 'donationDate', '', '".$GLOBALS["CONF_LANG"]."'); \n\t//-->\n</script>\n";
                     }
                     break;
             }
