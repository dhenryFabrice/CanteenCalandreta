 ...
 *                    in parameter, round the remaining amount to pay on a bill
 *     - 2020-07-01 : add HTML ID for some areas in the form
 *
 * @since 2012-01-16
 *
                 ...
                 else
                 {
                     switch($cUserAccess)
                     {
                         ...
                         case FCT_ACT_UPDATE:
                             ...
                             $DesactivationDate .= "<script language=\"JavaScript\" type=\"text/javascript\">\n<!--\n\t DesactivationDateCalendar = new dynCalendar('DesactivationDateCalendar', 'calendarCallback', '".$GLOBALS['CONF_ROOT_DIRECTORY']."Common/JSCalendar/images/', 'desactivationDate', '', '".$GLOBALS["CONF_LANG"]."'); \n\t//-->\n</script>\n";
                             break;
                     }
                 }
                             ...
                             else
                             {
                                 ...
                                 if ((isset($ArrayBillPayments["PaymentBillPartAmount"])) && (count($ArrayBillPayments["PaymentBillPartAmount"]) > 0))
                                 {
                                     ...
                                     $sProgressBar = generateProgressVisualIndicator(NULL, $TmpCurrBillAmount,
                                                                                     ...
                                                                                     .round($TmpCurrBillAmount - $ArrayBills["BillPaidAmount"][$i], 2)
                                                                                     ." ".$GLOBALS['CONF_PAYMENTS_UNIT']);
 ...
 *                    and $CONF_LANG in parameter
 *     - 2020-07-01 : add HTML ID for some areas
 *
 * @since 2012-01-24
 *
 * @param $DbConnection             DB object             Object of the opened database connection
