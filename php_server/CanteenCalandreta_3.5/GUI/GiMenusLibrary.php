 ...
 *     - 2019-05-07 : v3.2. Taken into account "add document approval" and "documents approvals list" items
 *     - 2019-11-20 : v3.3. Taken into account "create meeting room registration", "planning of meeting rooms"
 *                          and "all events" items
 *
 * @since 2012-01-12
 *
        ...
        case 'cooperation':
               displayContextualMenu(
                                     ...
                                     array(
                                           ...
                                           $GLOBALS["LANG_CONTEXTUAL_MENU_SUPPORT_COOP_ALL_EVENTS_LIST"],
                                           ...
                                           $GLOBALS["LANG_CONTEXTUAL_MENU_SUPPORT_COOP_CREATE_MEETING_ROOM_REGISTRATION"],
                                           $GLOBALS["LANG_CONTEXTUAL_MENU_SUPPORT_COOP_MEETING_ROOMS_PLANNING"]
                                          ),
                                     array(
                                           ...
                                           $RootLink."Cooperation/AllEventsList.php",
                                           ...
                                           $RootLink."Cooperation/CreateMeetingRoomRegistration.php?Cr=".md5('')."&amp;Id=",
                                           $RootLink."Cooperation/MeetingRoomsPlanning.php"
                                          ),
                                     array(
                                           ...
                                           $GLOBALS["LANG_CONTEXTUAL_MENU_SUPPORT_COOP_ALL_EVENTS_LIST_TIP"],
                                           ...
                                           $GLOBALS["LANG_CONTEXTUAL_MENU_SUPPORT_COOP_CREATE_MEETING_ROOM_REGISTRATION_TIP"],
                                           $GLOBALS["LANG_CONTEXTUAL_MENU_SUPPORT_COOP_MEETING_ROOMS_PLANNING_TIP"]
                                          ),
                                     $NumItemSelected,
                                     'cooperation_contextualmenu',
                                     array(Coop_CreateEvent, Coop_ClosedEventsList, Coop_FamiliesList, Coop_WorkGroupsList, Coop_GenerateTaxReceipt),
