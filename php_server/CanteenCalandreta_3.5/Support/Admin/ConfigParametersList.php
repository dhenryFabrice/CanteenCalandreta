...
/**
 * Support module : list parameters of configuration coming from the database
 * (and before, coming from Config.php)
 *
 ...
 */
 ...
 if ($HidOnPrint == 0)
 {
     ...
     displayStyledLinkText($LANG_GO_TO_CONTENT, '#ConfigParametersList', 'Accessibility');
     ...
     if (isSet($_SESSION["SupportMemberID"]))
     {
         ...
         displaySupportMemberContextualMenu("admin", 1, Admin_ConfigParametersList);
     ...
     displayTitlePage($LANG_SUPPORT_ADMIN_CONFIG_PARAMETERS_LIST_PAGE_TITLE, 2);

     openParagraph();
     echo $LANG_SUPPORT_ADMIN_CONFIG_PARAMETERS_LIST_PAGE_INTRODUCTION;
     closeParagraph();

     // Display a button to add a new config parameter
     openParagraph();
     echo generateStyledPictureHyperlink($GLOBALS["CONF_ADD_ICON"], "../Admin/AddConfigParameter.php?Cr=".md5('')."&amp;Id=",
                                         "$LANG_SUPPORT_ADMIN_CONFIG_PARAMETERS_LIST_PAGE_ADD_PARAMETER.", 'Affectation', '_blank')
          ." $LANG_SUPPORT_ADMIN_CONFIG_PARAMETERS_LIST_PAGE_ADD_PARAMETER.";
     closeParagraph();

     displaySearchConfigParametersForm($DbCon, $TabParams, "ConfigParametersList.php", $Page, "SortFct", $OrderBy,
                                       "UpdateConfigParameter.php", $CONF_ACCESS_APPL_PAGES[FCT_ADMIN]);
     ...
     if ($HidOnExport == 1)
     {
         exportSearchConfigParametersForm($DbCon, $TabParams, ${$ParamsPOST_GET}["hidExportFilename"]);
 ...
 {
     // Print the web page
     printSearchConfigParametersForm($DbCon, $TabParams);
