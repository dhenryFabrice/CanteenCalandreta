...
/**
 * Support module : allow a supporter to update an opened special day. The supporter must be logged to
 * update the opened special day.
 *
 ...
 */
 ...
 if (md5($Id) == $CryptedID)
 {
      displayDetailsOpenedSpecialDayForm($DbCon, $Id, "ProcessUpdateOpenedSpecialDay.php", $CONF_ACCESS_APPL_PAGES[FCT_ADMIN]);
 }
 else
 {
