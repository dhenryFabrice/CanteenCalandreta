...
/**
 * Support module : allow a supporter to update a holiday. The supporter must be logged to
 * update the holiday.
 *
 ...
 */
 ...
 if (md5($Id) == $CryptedID)
 {
      displayDetailsHolidayForm($DbCon, $Id, "ProcessUpdateHoliday.php", $CONF_ACCESS_APPL_PAGES[FCT_ADMIN]);
 }
 else
 {
