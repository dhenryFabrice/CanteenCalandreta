...
/**
 * Support module : allow a supporter to create a new child for a family.
 * The supporter must be logged to create the child.
 *
 ...
 */
 ...
 if (md5($Id) == $CryptedID)
 {
     displayDetailsChildForm($DbCon, 0, $Id, "ProcessNewChild.php", $CONF_ACCESS_APPL_PAGES[FCT_FAMILY]);
 }
 else
 {
     openFrame($LANG_ERROR);
     displayStyledText($LANG_ERROR_NOT_VIEW_CHILD, 'ErrorMsg');
     closeFrame();
 }
