...
/**
 * Support module : allow a supporter to update a payment. The supporter must be logged
 ...
 */
 ...
 if (md5($Id) == $CryptedID)
 {
      displayDetailsPaymentForm($DbCon, $Id, NULL, NULL, NULL, "ProcessUpdatePayment.php", $CONF_ACCESS_APPL_PAGES[FCT_PAYMENT]);
 }
 else
 {
