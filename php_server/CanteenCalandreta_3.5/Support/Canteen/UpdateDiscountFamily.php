...
/**
 * Support module : allow a supporter to update a discount/increase. The supporter must be logged
 * to update the discount/increase.
 *
 ...
 */
 ...
 if (md5($Id) == $CryptedID)
 {
      displayDetailsDiscountFamilyForm($DbCon, $Id, NULL, "ProcessUpdateDiscountFamily.php", $CONF_ACCESS_APPL_PAGES[FCT_PAYMENT]);
 }
 else
 {
