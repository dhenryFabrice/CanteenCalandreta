 ...
 *     - 2019-11-28 : v3.4. Get the PaymentType if the lPaymentType form field isn't set
 *
 * @since 2012-05-30
 */
 ...
 if (!empty($_POST["bSubmit"]))
 {
     if (isSet($_SESSION["SupportMemberID"]))
     {
         ...
         {
             // We get the current payment type
             $PaymentType = getTableFieldValue($DbCon, 'Payments', $PaymentID, 'PaymentType');
         }
