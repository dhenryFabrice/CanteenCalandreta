...
/**
 * Support module : display a synthesis for the selected day about nursery to the logged supporter
 *
 * @author Christophe Javouhey
 * @version 3.5
 *     - 2020-03-16 : v3.5. Taken into account CONF_NURSERY_OTHER_TIMESLOTS
 *
 * @since 2017-09-20
 */
 ...
 $TypeOfDisplay = 0;  // Default display is "children at the nursery"
 ...
 if (!$bOnPrint)
 {
     ...
     if (isSet($_SESSION["SupportMemberID"]))
     {
         ...
         displaySupportMemberContextualMenu("canteen", 1, Canteen_NurseryDaySynthesis);
     ...
     displayTitlePage($LANG_SUPPORT_NURSERY_DAY_SYNTHESIS_PAGE_TITLE, 2);
     ...
     switch($TypeOfDisplay)
     {
         case 1:
             ...
             displayStyledText($LANG_SUPPORT_NURSERY_DAY_SYNTHESIS_PAGE_INTRODUCTION_DONT_AT_NURSERY." "
         ...
         default:
             ...
             displayStyledText($LANG_SUPPORT_NURSERY_DAY_SYNTHESIS_PAGE_INTRODUCTION." "
                               .date($CONF_DATE_DISPLAY_FORMAT, strtotime("$Year-$Month-$Day")).".");
             break;
     }
     ...
     displayNurseryDaySynthesisForm($DbCon, "NurseryDaySynthesis.php", $Day, $Month, $Year, $TypeOfDisplay,
                                    $CONF_ACCESS_APPL_PAGES[FCT_NURSERY_PLANNING]);
 ...
 else
 {
     ...
     printNurseryDaySynthesis($DbCon, "NurseryDaySynthesis.php", $Day, $Month, $Year, $TypeOfDisplay,
                              $CONF_ACCESS_APPL_PAGES[FCT_NURSERY_PLANNING]);
