...
/**
 * Support module : allow a supporter to update an event registration. The supporter must be logged to update
 ...
 */
 ...
 if (md5($Id) == $CryptedID)
 {
      displayDetailsEventRegistrationForm($DbCon, $Id, 0, "ProcessUpdateEventRegistration.php",
