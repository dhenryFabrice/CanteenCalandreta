...
/**
 * Support module : list some events of the "maintenance" event category
 *
 ...
 */
 ...
 if ((!empty($_POST["bSubmit"])) || (array_key_exists("hidOrderByField", $_POST)) || ($LaunchSearch))
 {
     ...
     // Only "festive" category of events
     $TabParams["EventTypeCategory"] = array(1);
 ...
 if ($HidOnPrint == 0)
 {
     ...
     if (isSet($_SESSION["SupportMemberID"]))
     {
         ...
         displaySupportMemberContextualMenu("cooperation", 1, Coop_MaintenanceEventsList);
     ...
     displayTitlePage($LANG_SUPPORT_MAINTENANCE_EVENTS_LIST_PAGE_TITLE, 2);

     openParagraph();
     echo $LANG_SUPPORT_MAINTENANCE_EVENTS_LIST_PAGE_INTRODUCTION;
     closeParagraph();
     ...
     displaySearchEventForm($DbCon, $TabParams, "MaintenanceEventsList.php", $Page, "SortFct", $OrderBy, "UpdateEvent.php",
