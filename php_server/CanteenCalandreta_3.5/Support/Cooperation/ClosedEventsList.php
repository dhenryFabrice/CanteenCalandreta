...
/**
 * Support module : list closed events of all event categories
 *
 ...
 */
 ...
 if ($HidOnPrint == 0)
 {
     ...
     if (isSet($_SESSION["SupportMemberID"]))
     {
         ...
         displaySupportMemberContextualMenu("cooperation", 1, Coop_ClosedEventsList);
     ...
     displayTitlePage($LANG_SUPPORT_CLOSED_EVENTS_LIST_PAGE_TITLE, 2);

     openParagraph();
     echo $LANG_SUPPORT_CLOSED_EVENTS_LIST_PAGE_INTRODUCTION;
     closeParagraph();
     ...
     displaySearchEventForm($DbCon, $TabParams, "ClosedEventsList.php", $Page, "SortFct", $OrderBy, "UpdateEvent.php",
